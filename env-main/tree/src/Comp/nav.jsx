...
const Nav = () => {
    ...
    return (
        <>
            <div className="h-10 w-screen mt-2 font-serif bg-neutral-50 text-black flex justify-center font-bold text-2xl ">
                PLANT ONE MILLION TREES WITH US
            </div>

            <div className="flex flex-row bg-stone-400 h-20 w-screen items-center justify-between px-5">
