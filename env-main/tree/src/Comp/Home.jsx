...
const home=()=>
    {
        return(
            ...
            <div className="h-full w-full">
                <div className=" flex flex-row  text-center w-full p-20"> 
                    <div className=" flex flex-col p-10 w-1/2 h-[50%]">
                        <div className="bg-green-600 p-10 text-yellow-50 rounded-3xl ">
                            <h1 className="p-5 font-normal">Plant a million trees with us!</h1>
                ...
                <div className="bg-slate-100 flex flex-row justify-center w-full">
                    ...
                    <p className="text-gray-400 p-10 text-center ">The One More Tree Foundation was founded by two friends whose goal is to counteract climate change through pro-environmental activities. Our priority is to plant a million trees in Indai.
...
<form className="max-w-sm mx-auto">
  ...
  <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Denote</button>
</form>
